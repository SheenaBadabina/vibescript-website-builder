...
const PUBLIC_PREFIXES = ["/components/","/scripts/","/assets/","/images/","/favicon","/robots.txt","/sitemap.xml","/styles.css",
  "/api/signin","/api/signup","/api/signout","/api/verify","/api/resend-confirmation"];
const PUBLIC_EXACT = new Set(["/","/signin","/signup","/resend","/terms.html","/privacy.html"]);
...
export async function onRequest({ request, env, next }) {
  ...
  const cookies = parseCookies(request.headers.get("Cookie") || ""); const token = cookies[COOKIE];
