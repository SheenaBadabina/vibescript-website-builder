    ...
    <main className="min-h-dvh grid place-items-center p-6">
      <div className="w-full max-w-sm rounded-2xl bg-white/5 p-6 backdrop-blur">
        ...
        <button
          ...
          disabled={loading}
          className="w-full rounded-xl border border-white/10 bg-white/5 p-3 font-medium disabled:opacity-60"
        >
        ...
        <p className="mt-6 text-sm text-white/60">
          ...
          <a href="/auth/signup" className="text-teal-300 underline">Create one</a>
        </p>
      </div>
    </main>
  );
